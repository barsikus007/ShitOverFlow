var $jscomp=$jscomp||{};$jscomp.scope={};$jscomp.createTemplateTagFirstArg=function(a){return a.raw=a};$jscomp.createTemplateTagFirstArgWithRaw=function(a,c){a.raw=c;return a};function checker(a){var c=a.elements.comment.value;a=a.elements.name.value;if(2<=a.length&&64>=a.length&&3<=c.length)return!0}
function addChecker(){var a=document.querySelectorAll(".needs-validation");Array.prototype.slice.call(a).forEach(function(c){c.addEventListener("submit",function(d){checker(c)||(d.preventDefault(),d.stopPropagation(),Array.prototype.slice.call(c.getElementsByTagName("input")).forEach(function(g){g.classList.add("is-invalid")}));c.checkValidity()||(d.preventDefault(),d.stopPropagation());c.classList.add("was-validated")},!1)})}addChecker();
